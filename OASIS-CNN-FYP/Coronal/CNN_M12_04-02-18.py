#################################################################################################################
# 
#	FILE NAME   : CNN_M12_04-02-18.py
#	DESCRIPTION : Attempt 12 of basic CNN model. LeNet5 architecture. Run locally on Laptop.
...
history = model.fit(X_train, y_train,epochs=12, batch_size=5, verbose=1, validation_data=(X_test, y_test), callbacks=[tbCallBack])
