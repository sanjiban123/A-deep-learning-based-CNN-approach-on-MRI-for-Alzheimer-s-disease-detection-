#################################################################################################################
# 
#	FILE NAME   : C_CNN_M39_01-03-18.py
...
label_for_class_0 = 0.4
label_for_class_1 = 0.6
...
if image_datagen_var == 0:
    history = model.fit(X_train, y_train, epochs=5, batch_size=5, verbose=2, validation_data=(X_test, y_test), callbacks=[tbCallBack])
else:
