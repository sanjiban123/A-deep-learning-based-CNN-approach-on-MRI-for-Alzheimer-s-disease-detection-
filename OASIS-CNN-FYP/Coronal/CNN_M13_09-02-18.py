#################################################################################################################
# 
#	FILE NAME   : CNN_M13_09-02-18.py
#	DESCRIPTION : Attempt 13 of basic CNN model. Run locally on Laptop. Includes seeds. Attempt at k-fold cross validation
...
for train, test in kfold.split(X_train, y_train):
    ...
    # model.add(Convolution2D(64, kernel_size=(5, 5), activation='relu', input_shape=input_shape))
    model.add(Convolution2D(32, kernel_size=(5, 5), activation='relu', input_shape=input_shape))
    ...
    history = model.fit(X_train[train], y_train[train],epochs=10, batch_size=5, verbose=1)
