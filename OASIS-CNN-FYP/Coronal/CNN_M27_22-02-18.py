#################################################################################################################
# 
#	FILE NAME   : CNN_M27_22-02-18.py
#	DESCRIPTION : Attempt 27 of basic CNN model. VGGNet19 architecture. (sliced images), with normalisation jugaad.
...
model.add(Convolution2D(64, kernel_size=3, strides=3, activation='relu', padding='same', input_shape=input_shape))
model.add(Convolution2D(64, kernel_size=3, strides=3, activation='relu', padding='same'))
# model.add(MaxPooling2D((2,2), strides=(2,2)))

model.add(Convolution2D(128, kernel_size=3, strides=3, activation='relu', padding='same'))
model.add(Convolution2D(128, kernel_size=3, strides=3, activation='relu', padding='same'))
model.add(MaxPooling2D((2,2), strides=(2,2)))

model.add(Convolution2D(256, kernel_size=3, strides=3, activation='relu', padding='same'))
model.add(Convolution2D(256, kernel_size=3, strides=3, activation='relu', padding='same'))
model.add(Convolution2D(256, kernel_size=3, strides=3, activation='relu', padding='same'))
model.add(Convolution2D(256, kernel_size=3, strides=3, activation='relu', padding='same'))
# model.add(MaxPooling2D((2,2), strides=(2,2)))
...
history = model.fit(X_train, y_train,epochs=80, batch_size=5, verbose=1, validation_data=(X_test, y_test), callbacks=[tbCallBack])
