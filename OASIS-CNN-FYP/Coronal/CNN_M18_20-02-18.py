#################################################################################################################
# 
#	FILE NAME   : CNN_M18_20-02-18.py
#	DESCRIPTION : Attempt 18 of basic CNN model. Run locally on Laptop.
...
history = model.fit(X_train, y_train,epochs=25, batch_size=5, verbose=1, validation_data=(X_test, y_test), callbacks=[tbCallBack])
