#################################################################################################################
# 
#	FILE NAME   : CNN_M1_29-01-18.py
#	DESCRIPTION : Attempt 1 of basic CNN model. Run locally on Laptop.
...
history = model.fit(X_train, y_train,epochs=10, batch_size=1, verbose=1, validation_data=(X_test, y_test), callbacks=[tbCallBack])
