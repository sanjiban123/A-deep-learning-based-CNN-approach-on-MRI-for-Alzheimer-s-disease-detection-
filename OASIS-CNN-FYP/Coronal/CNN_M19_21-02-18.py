#################################################################################################################
# 
#	FILE NAME   : CNN_M19_21-02-18.py
#	DESCRIPTION : Attempt 19 of basic CNN model. Run locally on Laptop. Only dense layers, uses flattened image data saved in hdf5 file.
...
model.add(Dense(64, activation='relu', input_dim=30976))
