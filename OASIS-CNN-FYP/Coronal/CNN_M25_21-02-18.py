#################################################################################################################
# 
#	FILE NAME   : CNN_M25_21-02-18.py
#	DESCRIPTION : Attempt 25 of basic CNN model. Run locally on Laptop. Only dense layers.
...
model.add(Dense(512, activation='linear', input_dim=8100))
