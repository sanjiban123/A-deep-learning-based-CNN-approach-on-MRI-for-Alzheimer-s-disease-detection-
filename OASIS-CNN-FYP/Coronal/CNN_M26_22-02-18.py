#################################################################################################################
# 
#	FILE NAME   : CNN_M26_22-02-18.py
#	DESCRIPTION : Attempt 26 of basic CNN model. Run locally on Laptop. 1 Conv + 1 De.
...
history = model.fit(X_train, y_train,epochs=2, batch_size=5, verbose=1, validation_data=(X_test, y_test), callbacks=[tbCallBack])
