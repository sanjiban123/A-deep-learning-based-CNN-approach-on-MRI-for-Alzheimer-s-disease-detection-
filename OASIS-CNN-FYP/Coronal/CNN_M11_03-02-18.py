#################################################################################################################
# 
#	FILE NAME   : CNN_M11_03-02-18.py
#	DESCRIPTION : Attempt 11 of basic CNN model. LeNet5 architecture. Run locally on Laptop.
...
history = model.fit(X_train, y_train,epochs=70, batch_size=5, verbose=1, validation_data=(X_test, y_test), callbacks=[tbCallBack])
