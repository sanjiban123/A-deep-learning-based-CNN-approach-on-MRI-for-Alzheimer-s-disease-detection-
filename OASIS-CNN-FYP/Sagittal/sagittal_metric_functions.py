...
file = open('Sagittal Outputs/' + str(modelName) + '/' + str(modelName) + "_Metrics.txt", "w")
...
def MetricCalc(parameter_a, parameter_b, dataset_type):
    ...
    plt.savefig('Sagittal Outputs/' + str(modelName) + '/' + str(modelName) + '_CNFMatrix' + str(dataset_type) + '.png', dpi=150)
...
file = open('Sagittal Outputs/' + str(modelName) + '/' + str(modelName) + "_Metrics.txt", "a")
file.write('FORMULAS:\n')
