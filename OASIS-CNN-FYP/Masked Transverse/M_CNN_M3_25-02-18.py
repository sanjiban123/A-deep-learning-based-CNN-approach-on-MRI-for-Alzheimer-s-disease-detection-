#################################################################################################################
# 
#	FILE NAME   : M_CNN_M3_25-02-18.py
...
if image_datagen_var == 0:
    ...
    if cloud_var == 0:
        history = model.fit_generator(datagen.flow(X_train, y_train, batch_size=47), steps_per_epoch=5*len(X_train), epochs=2, verbose=1, validation_data=(X_test, y_test), callbacks=[tbCallBack])
    else:
